...
module signal_proc_tb;
    ...
    integer iface_v, ds_v, out_act_v, dbin_v;
    ...
    initial begin
        ...
        r = $fscanf(stim_fd, " %d,%d,%d,%d", iface_v, ds_v, out_act_v, dbin_v);
        while (r == 4) begin
